...
public class CheckoutPageHelper extends CheckoutPageObject {
        ...
        public void clickButtonAgree() {getButtonAgree().click();}
        public void clickButtonCheckout() {getButtonCheckout().click();}
        ...
        public void clickButtonCity(String item) {getButtonCity().click();
        getButtonCity().clear();
        ...
        public void clickButtonContinueNextStepNewAddress() {getButtonContinueNextStepNewAddress().click();}
        public void clickButtonPickUp() {getButtonPickUp().click();}
        public void clickButtonContinueNextShippingAddress() {getButtonContinueNextStepShippingAddress().click();}
        public void clickButtonShippingOptionGround() {getButtonShippingOptionGround().click();}
        public void clickButtonShippingOptionNextDayAir() {getButtonShippingOptionNextDayAir().click();}
        public void clickButtonShippingOption2ndDayAir() {getButtonShippingOption2ndDayAir().click();}
        public void clickButtonContinueNextStepPaymentMethod() {getButtonContinueNextStepPaymentMethod().click();}
        public void clickButtonPaymentMethodCash() {getButtonPaymentMethodCash().click();}
        public void clickButtonPaymentMethodCheck() {getButtonPaymentMethodCheck().click();}
        public void clickButtonSelectCreditCard() {getButtonSelectCreditCard().click();}
        ...
        public void clickButtonExpirationDateMonth() {getButtonExpirationDateMonth().click();}
        public void clickButtonExpirationDateYear() {getButtonExpirationDateYear().click();}
        public void clickButtonCardCode(String item) {
            getButtonCardCode().clear();
            getButtonCardCode().sendKeys(item);}
        public void clickButtonPaymentMethodPurchaseOrder() {getButtonPaymentMethodPurchaseOrder().click();}
        ...
        public void clickButtonPaymentMethodCreditCard() {getButtonPaymentMethodCreditCard().click();}
        public void clickButtonContinueNextStepPaymentInformation() {getContinueNextStepPaymentInformation().click();}
        public void clickButtonContinueNextStepConfirmOrder() {getButtonContinueNextStepConfirmOrder().click();}
        public void clickButtonConfirmNextStepThankYouPage() {getButtonConfirmNextStepThankYouPage().click();}
        public void clickButtonContinueBackToHomePage() {getButtonContinueBackToHomePage().click();}
    }
